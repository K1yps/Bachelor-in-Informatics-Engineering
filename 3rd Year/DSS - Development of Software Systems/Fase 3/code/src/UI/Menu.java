...
public class Menu {
    ...
    public interface MenuHandler {
        void execute() throws ZonaInvalidaException, PrateleiraJaExisteException, ZonaJaExisteException, VerticeInvalidoException;
    }
        ...
        do {
            ...
            if (op > 0 && !this.disponivel.get(op - 1).validate()) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    System.out.println("Failed to execute querie: " + e.getMessage());
                }
