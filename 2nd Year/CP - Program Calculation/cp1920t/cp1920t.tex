...
\\
\>[B]{}\Varid{discollect}\;\Varid{x}\mathrel{=}[\mskip1.5mu (\Varid{a},\Varid{b})\mid (\Varid{a},\Varid{l})\leftarrow \Varid{x},\Varid{b}\leftarrow \Varid{l}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{tar}\mathrel{=}\Varid{cataExp}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}{}\<[E]%
\\
\>[6]{}\hsindent{2}{}\<[8]%
\>[8]{}\Varid{g}\mathrel{=}\alt{\Varid{singl}\comp \conj{\Varid{nil}}{\Varid{id}}}{\uncurry{\Varid{fstconcat}}}{}\<[E]%
\\
\>[6]{}\hsindent{2}{}\<[8]%
\>[8]{}\Varid{fstconcat}\;\Varid{x}\;\Varid{y}\mathrel{=}[\mskip1.5mu (\Varid{a},\Varid{b})\mid \Varid{l}\leftarrow \Varid{y},(\p1,\Varid{b})\leftarrow \Varid{l},\mathbf{let}\;\Varid{a}\mathrel{=}\Varid{x}\plus \p1\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dic\char95 rd}\;\Varid{p}\;\Varid{t}\mathrel{=}\Varid{lookup}\;\Varid{p}\;(\Varid{dic\char95 exp}\;\Varid{t}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dic\char95 in}\;\Varid{p}\;\Varid{s}\mathrel{=}\Conid{Term}\;\text{\ttfamily \char34 \char34}\comp \map \;(\Varid{bmap}\;{}\<[35]%
\>[35]{}\Varid{id}\;\Varid{singl})\comp \Varid{untar}\comp (\Varid{curry}\;(\Varid{cons})\;(\Varid{p},\Varid{s}))\comp \Varid{discollect}\comp \Varid{dic\char95 exp}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{maybe\char95 id}\;\Varid{k}\;\Varid{x}\mathrel{=}\Varid{maybe}\;\Varid{k}\;\Varid{id}\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{node\char95 maior}\;\Varid{k}\;\Varid{x}\mathrel{=}\Varid{p2p}\;((\Varid{k}\geq \Conid{Just}\;\Varid{x}),\Conid{True})\;(\Varid{x}\equiv \Conid{Nothing}){}\<[E]%
\\
\>[B]{}\Varid{node\char95 menor}\;\Varid{k}\;\Varid{x}\mathrel{=}\Varid{p2p}\;((\Varid{k}\leq \Conid{Just}\;\Varid{x}),\Conid{True})\;(\Varid{x}\equiv \Conid{Nothing}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{maisDir}\mathrel{=}\Varid{cataBTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\Conid{Nothing}}}{\Conid{Just}\comp \uncurry{(\Varid{maybe\char95 id})}\comp (\Varid{id}\times\p2)}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{maisEsq}\mathrel{=}\Varid{cataBTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\Conid{Nothing}}}{\Conid{Just}\comp \uncurry{(\Varid{maybe\char95 id})}\comp (\Varid{id}\times\p1)}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isOrd}\mathrel{=}\p1\comp \Varid{isOrd'}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{insOrd}\;\Varid{x}\mathrel{=}\p1\comp \Varid{insOrd'}\;\Varid{x}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{maxBtree}\mathbin{::}(\Conid{Ord}\;\Varid{a})\Rightarrow {}\<[26]%
\>[26]{}\Varid{a}\to \fun{BTree} \;\Varid{a}\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{maxBtree}\;\Varid{a}\mathrel{=}\Varid{cataBTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\Conid{True}}}{\Varid{res}}{}\<[E]%
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}\Varid{res}\;(\Varid{x},(\Varid{b},\Varid{c}))\mathrel{=}(\Varid{x}\mathbin{<}\Varid{a})\mathrel{\wedge}\Varid{b}\mathrel{\wedge}\Varid{c}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{minBtree}\mathbin{::}(\Conid{Ord}\;\Varid{a})\Rightarrow \Varid{a}\to \fun{BTree} \;\Varid{a}\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{minBtree}\;\Varid{a}\mathrel{=}\Varid{cataBTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\Conid{True}}}{\Varid{res}}{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{(\Conid{True},\Conid{Empty})}}{\Varid{sndf}}{}\<[E]%
\\
\>[8]{}\hsindent{6}{}\<[14]%
\>[14]{}\Varid{sndf}\;(\Varid{a},((\Varid{b},\Varid{c}),(\Varid{d},\Varid{e})))\mathrel{=}((\Varid{maxBtree}\;\Varid{a}\;\Varid{c})\mathrel{\wedge}(\Varid{minBtree}\;\Varid{a}\;\Varid{e})\mathrel{\wedge}\Varid{b}\mathrel{\wedge}\Varid{d},\Conid{Node}\;(\Varid{a},(\Varid{c},\Varid{e}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{insOrd'}\;\Varid{x}\mathrel{=}\Varid{cataBTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{(\underline{((\Conid{Node}\;(\Varid{x},(\Conid{Empty},\Conid{Empty}))),\Conid{Empty})})}{\Varid{sndf}}{}\<[E]%
\\
\>[8]{}\hsindent{6}{}\<[14]%
\>[14]{}\Varid{sndf}\;(\Varid{a},((\Varid{b},\Varid{c}),(\Varid{d},\Varid{e})))\mathrel{=}\mathbf{if}\;(\Varid{x}\mathbin{>}\Varid{a})\;\mathbf{then}\;(\Conid{Node}\;(\Varid{a},(\Varid{b},\Varid{e})),\Conid{Node}\;(\Varid{a},(\Varid{c},\Varid{e})))\;\mathbf{else}\;(\Conid{Node}\;(\Varid{a},(\Varid{d},\Varid{c})),\Conid{Node}\;(\Varid{a},(\Varid{c},\Varid{e}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rrot}\;(\Conid{Node}\;(\Varid{x},(\Conid{Node}\;(\Varid{y},(\Varid{a},\Varid{b})),\Varid{right})))\mathrel{=}\Conid{Node}\;(\Varid{y},(\Varid{a},\Conid{Node}\;(\Varid{x},(\Varid{b},\Varid{right})))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{lrot}\;(\Conid{Node}\;(\Varid{x},(\Varid{left},(\Conid{Node}\;(\Varid{y},(\Varid{a},\Varid{b}))))))\mathrel{=}\Conid{Node}\;(\Varid{y},((\Conid{Node}\;(\Varid{x},(\Varid{left},\Varid{a})),\Varid{b}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{splay}\;\Varid{l}\;\Varid{t}\mathrel{=}(\Varid{cataList}\;\alt{\underline{\Varid{id}}}{\Varid{parseBTree}\comp \alt{\underline{\Varid{rrot}}\times\Varid{id}}{\underline{\Varid{lrot}}\times\Varid{id}}\comp \Varid{grd}\;(\Varid{id}\comp \p1)}\;\Varid{l})\;\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{parseBTree}\;(\Varid{f},\Varid{g})\mathrel{=}{}\<[37]%
\>[37]{}\alt{\underline{\Conid{Empty}}}{\Varid{f}\comp \Varid{g}\comp \Conid{Node}}\comp {}\<[76]%
\>[76]{}\Varid{outBTree}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{extLTree}\mathrel{=}\Varid{cataBdt}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Conid{Leaf}}{\Conid{Fork}\comp \p2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inBdt}\mathrel{=}\alt{\Conid{Dec}}{\Conid{Query}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outBdt}\;(\Conid{Dec}\;\Varid{a})\mathrel{=}i_1\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{outBdt}\;(\Conid{Query}\;\Varid{b})\mathrel{=}i_2\;\Varid{b}{}\<[E]%
\\[\blanklineskip]%
...
&
    \ensuremath{\Conid{A}\mathbin{+}\Conid{String}\times\Conid{Bdt}\;\Conid{A}\times\Conid{Bdt}\;\Conid{A}}
...
&
    \ensuremath{\Conid{A}\mathbin{+}\Conid{String}\times\Conid{A}\times\Conid{A}}
           \ar[u]_{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times} \ana g \ensuremath{\times} \ana g}
}
\end{eqnarray*}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{constLeaf}}{\Varid{parseList}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{constLeaf}\;\Varid{x}\mathrel{=}\underline{(\Conid{Leaf}\;\Varid{x})}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{parseList}\;(\Varid{a},\Varid{b}){}\<[26]%
\>[26]{}\mathrel{=}{}\<[26E]%
\>[29]{}\alt{\Conid{Fork}\comp \conj{\Varid{a}\comp \Varid{nil}}{\Varid{b}\comp \Varid{nil}}}{\alt{\Varid{a}\comp \p2}{\Varid{b}\comp \p2}\comp \Varid{grd}\;\p1}\comp \Varid{outList}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{constLeaf}}{\Varid{parseBTree}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{constLeaf}\;\Varid{x}\mathrel{=}\underline{(\Conid{Leaf}\;\Varid{x})}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{parseBTree}\;(\Varid{a},\Varid{b}){}\<[27]%
\>[27]{}\mathrel{=}{}\<[27E]%
\>[30]{}\alt{\Conid{Fork}\comp \conj{\Varid{a}\comp \underline{\Conid{Empty}}}{\Varid{b}\comp \underline{\Conid{Empty}}}}{\alt{\Varid{a}\comp \p1\comp \p2}{\Varid{b}\comp \p2\comp \p2}\comp \Varid{grd}\;\p1}\comp \Varid{outBTree}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pbnavLTree}\mathrel{=}\Varid{cataLTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{constLeaf}}{\Varid{parseBTreeDist}}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{constLeaf}\;\Varid{x}\mathrel{=}\underline{(\Varid{return}\;(\Conid{Leaf}\;\Varid{x}))}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{parseBTreeDist}\;(\Varid{a},\Varid{b}){}\<[33]%
\>[33]{}\mathrel{=}{}\<[33E]%
\>[36]{}\alt{\Varid{return}\comp \Conid{Fork}\comp \conj{\Varid{coU}\comp \Varid{a}}{\Varid{coU}\comp \Varid{b}}\comp \underline{\Conid{Empty}}}{\Varid{probCond}\;(\Varid{a},\Varid{b})}\comp \Varid{outBTree}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{probCond}\;(\Varid{a},\Varid{b})\;(\Varid{dist},\Varid{x})\mathrel{=}\uncurry{(\mathsf{cond}\;\Varid{dist})}\;((\Varid{a}\times\Varid{b})\;\Varid{x}){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{coU}\mathrel{=}\Varid{head}\comp \Varid{extract}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{14}{}\<[14]%
\>[14]{}\text{\ttfamily \char34 Truchet-Smith~Mosaic\char34}\;{}\<[38]%
\>[38]{}\mbox{\onelinecomment  window title}{}\<[E]%
\\
\>[B]{}\hsindent{14}{}\<[14]%
\>[14]{}(\mathrm{800},\mathrm{800})\;{}\<[38]%
\>[38]{}\mbox{\onelinecomment  window size}{}\<[E]%
\\
\>[B]{}\hsindent{14}{}\<[14]%
\>[14]{}(\mathrm{0},\mathrm{0}){}\<[38]%
\>[38]{}\mbox{\onelinecomment  window position}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{truchetMosaic}\;\Varid{sx}\;\Varid{sy}\mathrel{=}\mathbf{let}\;\Varid{draw}\;\Varid{x}\;\Varid{y}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{27}{}\<[27]%
\>[27]{}\Varid{draw}\;\Varid{x}\;\Varid{y}\;(\Varid{t}\mathbin{:}\Varid{ts})\mid \Varid{x}\mathbin{+}\mathrm{400}\mathbin{<}(\Varid{sx}\mathbin{*}\mathrm{80}){}\<[63]%
\>[63]{}\mathrel{=}\Varid{put}\;((\Varid{fromIntegral}\;\Varid{x}),\Varid{y})\;\Varid{t}\mathbin{:}\Varid{draw}\;(\Varid{x}\mathbin{+}\mathrm{80})\;\Varid{y}\;\Varid{ts}{}\<[E]%
\\
\>[27]{}\hsindent{16}{}\<[43]%
\>[43]{}\mid \Varid{otherwise}{}\<[62]%
\>[62]{}\mathrel{=}\Varid{draw}\;(\mathbin{-}\mathrm{400})\;(\Varid{y}\mathbin{+}\mathrm{80})\;(\Varid{t}\mathbin{:}\Varid{ts}){}\<[E]%
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\mathbf{in}\;\mathbf{do}{}\<[E]%
\\
\>[23]{}\hsindent{2}{}\<[25]%
\>[25]{}\Varid{nt1}\leftarrow \Varid{randomRIO}\;(\mathrm{0},(\Varid{sx}\mathbin{*}\Varid{sy})){}\<[E]%
\\
\>[23]{}\hsindent{2}{}\<[25]%
\>[25]{}\Varid{list}\leftarrow \Varid{permuta}\;((\Varid{replicate}\;\Varid{nt1}\;\Varid{truchet1})\plus (\Varid{replicate}\;((\Varid{sx}\mathbin{*}\Varid{sy})\mathbin{-}\Varid{nt1})\;\Varid{truchet2})){}\<[E]%
\\
\>[23]{}\hsindent{2}{}\<[25]%
\>[25]{}\Varid{display}\;\Varid{janela}\;\Varid{white}\;(\Varid{pictures}\;(\Varid{draw}\;(\mathbin{-}\mathrm{400})\;(\mathbin{-}\mathrm{400})\;\Varid{list})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{main}\mathrel{=}\mathbf{do}\;\Varid{truchetMosaic}\;\mathrm{20}\;\mathrm{20}{}\<[E]%
\\[\blanklineskip]%
...
\end{hscode}\resethooks
    ...
    \caption{Um mosaico 10\ensuremath{\times}10 gerado pelo progama}
